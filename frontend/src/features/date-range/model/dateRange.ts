export type DateRangePreset = '30days' | 'currentMonth' | '90days' | '6months' | '12months' | 'ytd' | 'allTime' | '24months' | '36months';
...
export const DATE_RANGE_PRESETS: ReadonlyArray<{ id: DateRangePreset; label: string }> = [
  ...
  { id: '24months', label: 'Last 24 Months' },
  { id: '36months', label: 'Last 36 Months' },
];
